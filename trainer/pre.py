...
class PreTrainer(object):
    ...
    def __init__(self, args):
        ...
        # Load pretrain set
        self.trainset = Dataset('train', self.args, augment=True)
        ...
        self.model = TasLearner(self.args, mode='pre', num_cls=num_class_pretrain)
    ...
    def train(self):
        ...
        for epoch in range(1, self.args.pre_max_epoch + 1):
            ...
            for i, batch in enumerate(self.val_loader, 1):
                ...
                logits_dist, logits_sim = self.model((data_shot, label_shot, data_query))
                loss = F.cross_entropy(logits_dist, label)
