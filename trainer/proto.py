...
from dataloader.dataset_loaderIm import DatasetLoader as Dataset
...
class ProtoTrainer(object):
    ...
    def __init__(self, args):
        ...
        meta_base_dir = osp.join(log_base_dir, 'proto')
        ...
        # Build model
        self.model = TasLearner(self.args, mode='proto')

        # Set optimizer
        self.optimizer = torch.optim.Adam([
            {'params': self.model.encoder.parameters(), 'lr': self.args.vlr}], lr=self.args.vlr)
        ...
        for epoch in range(1, self.args.max_epoch + 1):
            ...
            for i, batch in enumerate(tqdm_gen, 1):
                ...
                tqdm_gen.set_description(
                    'Epoch {}, Loss={:.4f} Acc={:.4f}'.format(epoch, loss.item(), acc))
            ...
            print('     Train Average, Loss={:.4f} Acc={:.4f}'
                  .format(train_loss_averager,train_acc_averager))
            ...
            print('     Val Average, Loss={:.4f} Acc={:.4f}'
                  .format(val_loss_averager, val_acc_averager))
    ...
    def eval(self):
        ...
        for i, batch in enumerate(loader, 1):
            ...
            if i % 100 == 0:
                print('batch {}: {:.2f}({:.2f})'
                      .format(i, ave_acc.item() * 100, acc * 100))
